...
# INTERPRETACIÓN PEDAGÓGICA
    ...
    En esta etapa del algoritmo K-Means, Cada punto calcula su distancia hacia todos los centroides, Luego se asigna al centroide más cercano.Las líneas representan esa relación de cercanía.

    ###  Puntos cercanos a fronteras

    Algunos datos pueden observarse muy alejados de su centroide o cercanos a otro cluster.

    Esto ocurre porque las fronteras entre clusters no son rígidas, existen regiones intermedias, algunos individuos comparten características similares con varios grupos.

    ###  ¿Qué puede pasar?

    Cuando un punto queda cerca de otro centroide puede cambiar de cluster en la siguiente iteración.Esto provoca movimiento de centroides, reajuste de grupos y búsqueda de agrupaciones más compactas.

    ###  Interpretación matemática

    K-Means minimiza la distancia total entre cada punto y su centroide asignado.Por eso si un punto está demasiado lejos, el algoritmo intentará reorganizar los clusters.
     """)
